      ...
      root: {
        ...
        themeConfig: {
          ...
          sidebar: [
            ...
            {
              text: "Benchmarks",
              items: [{ text: "JobBench results", link: "/benchmarks" }],
            },
            {
              text: "Built-in tools",
              items: [
      ...
      zh: {
        ...
        themeConfig: {
          ...
          sidebar: [
            ...
            {
              text: "评测",
              items: [{ text: "JobBench 成绩", link: "/zh/benchmarks" }],
            },
            {
              text: "流式与 UI",
              items: [
      ...
      ja: {
        ...
        themeConfig: {
          ...
          sidebar: [
            ...
            {
              text: "ベンチマーク",
              items: [{ text: "JobBench 結果", link: "/ja/benchmarks" }],
            },
            {
              text: "組み込みツール",
              items: [
