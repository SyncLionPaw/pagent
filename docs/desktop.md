...
<div class="desktop-showcase-grid">
  <figure class="desktop-showcase-card desktop-showcase-featured">
    <a href="./desktop/showcase/document-workflow.png" target="_blank" rel="noopener" class="desktop-showcase-image">
      <img src="/desktop/showcase/document-workflow.png" alt="pagent Desktop completing a document task while previewing the delivered PDF" />
    </a>
    <figcaption>
      <strong>Build and inspect documents</strong>
      <span>Follow the agent's work, open delivered files, and inspect the generated PDF in the same window.</span>
    </figcaption>
  </figure>
  <figure class="desktop-showcase-card">
    <a href="./desktop/showcase/visual-creation.png" target="_blank" rel="noopener" class="desktop-showcase-image">
      <img src="/desktop/showcase/visual-creation.png" alt="pagent Desktop generating an illustrated poster and editable SVG source" loading="lazy" />
    </a>
    <figcaption>
      <strong>Create visual artifacts</strong>
      <span>Generate images and editable source files, then preview both without leaving the task.</span>
    </figcaption>
  </figure>
  <figure class="desktop-showcase-card">
    <a href="./desktop/showcase/multimodal-preview.png" target="_blank" rel="noopener" class="desktop-showcase-image">
      <img src="/desktop/showcase/multimodal-preview.png" alt="pagent Desktop using an uploaded image while previewing generated HTML" loading="lazy" />
    </a>
    <figcaption>
      <strong>Work multimodally</strong>
      <span>Attach visual references in chat and compare generated web output side by side.</span>
    </figcaption>
  </figure>
</div>
...
<!-- Placeholder screenshot hidden: /desktop/01-open-warning.png -->
...
<!-- Placeholder screenshot hidden: /desktop/02-setup-env.png -->
...
<!-- Placeholder screenshot hidden: /desktop/03-setup-apikey.png -->
...
<!-- Placeholder screenshot hidden: /desktop/04-setup-sandbox.png -->
...
<!-- Placeholder screenshot hidden: /desktop/06-new-task.png -->
...
<!-- Placeholder screenshot hidden: /desktop/05-main-window.png -->
...
<!-- Placeholder screenshot hidden: /desktop/07-composer.png -->
...
<!-- Placeholder screenshot hidden: /desktop/08-artifacts.png -->
...
<!-- Placeholder screenshot hidden: /desktop/09-delete-confirm.png -->
...
<!-- Placeholder screenshot hidden: /desktop/10-settings.png -->
